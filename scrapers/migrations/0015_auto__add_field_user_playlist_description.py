...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User_playlist.description'
        db.add_column('scrapers_user_playlist', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User_playlist.description'
        db.delete_column('scrapers_user_playlist', 'description')
