...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('scrapers_artist', 'mbid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Label.mbid'
        db.add_column('scrapers_label', 'mbid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('scrapers_artist', 'mbid')

        # Deleting field 'Label.mbid'
        db.delete_column('scrapers_label', 'mbid')
