...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User_playlist_entry.user_playlists'
        db.add_column('scrapers_user_playlist_entry', 'user_playlists',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='entries', null=True, to=orm['scrapers.User_playlist']),
                      keep_default=False)

        # Adding field 'User_playlist_entry.sound'
        db.add_column('scrapers_user_playlist_entry', 'sound',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user_playlist_entries', null=True, to=orm['scrapers.Sound']),
                      keep_default=False)

        # Adding field 'User_playlist_entry.embed'
        db.add_column('scrapers_user_playlist_entry', 'embed',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user_playlist_entries', null=True, to=orm['scrapers.Embed']),
                      keep_default=False)

        # Adding field 'User_playlist_entry.album'
        db.add_column('scrapers_user_playlist_entry', 'album',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user_playlist_entries', null=True, to=orm['scrapers.Album']),
                      keep_default=False)

        # Adding field 'User_playlist_entry.date_added'
        db.add_column('scrapers_user_playlist_entry', 'date_added',
    ...
    def backwards(self, orm):
        # Deleting field 'User_playlist_entry.user_playlists'
        db.delete_column('scrapers_user_playlist_entry', 'user_playlists_id')

        # Deleting field 'User_playlist_entry.sound'
        db.delete_column('scrapers_user_playlist_entry', 'sound_id')

        # Deleting field 'User_playlist_entry.embed'
        db.delete_column('scrapers_user_playlist_entry', 'embed_id')

        # Deleting field 'User_playlist_entry.album'
        db.delete_column('scrapers_user_playlist_entry', 'album_id')

        # Deleting field 'User_playlist_entry.date_added'
        db.delete_column('scrapers_user_playlist_entry', 'date_added')
    ...
    models = {
        ...
        'scrapers.user_playlist_entry': {
            ...
            'user_playlists': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'entries'", 'null': 'True', 'to': "orm['scrapers.User_playlist']"})
        },
