...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scrapers_release_artists', (
        ...
        db.create_unique('scrapers_release_artists', ['release_id', 'artist_id'])

        # Adding M2M table for field labels on 'Release'
        db.create_table('scrapers_release_labels', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('release', models.ForeignKey(orm['scrapers.release'], null=False)),
            ('label', models.ForeignKey(orm['scrapers.label'], null=False))
        ))
        db.create_unique('scrapers_release_labels', ['release_id', 'label_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('scrapers_release_artists')

        # Removing M2M table for field labels on 'Release'
        db.delete_table('scrapers_release_labels')
