...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User_playlist_entry.user_playlist'
        db.add_column('scrapers_user_playlist_entry', 'user_playlist',
    ...
    def backwards(self, orm):
        ...
        db.add_column('scrapers_user_playlist_entry', 'user_playlists',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='entries', null=True, to=orm['scrapers.User_playlist'], blank=True),
                      keep_default=False)

        # Deleting field 'User_playlist_entry.user_playlist'
        db.delete_column('scrapers_user_playlist_entry', 'user_playlist_id')
