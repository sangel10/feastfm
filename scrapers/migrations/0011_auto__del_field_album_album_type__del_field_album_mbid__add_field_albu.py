...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Album.album_type'
        db.delete_column('scrapers_album', 'album_type')

        # Deleting field 'Album.mbid'
        db.delete_column('scrapers_album', 'mbid')

        # Adding field 'Album.reid'
        db.add_column('scrapers_album', 'reid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Album.scraped'
        db.add_column('scrapers_album', 'scraped',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Album.album_type'
        db.add_column('scrapers_album', 'album_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Album.mbid'
        db.add_column('scrapers_album', 'mbid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Deleting field 'Album.reid'
        db.delete_column('scrapers_album', 'reid')

        # Deleting field 'Album.scraped'
        db.delete_column('scrapers_album', 'scraped')
