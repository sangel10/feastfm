...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scrapers_artistname', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
        ))
        db.send_create_signal('scrapers', ['ArtistName'])

        # Adding M2M table for field artists on 'ArtistName'
        m2m_table_name = db.shorten_name('scrapers_artistname_artists')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('artistname', models.ForeignKey(orm['scrapers.artistname'], null=False)),
            ('artist', models.ForeignKey(orm['scrapers.artist'], null=False))
        ))
        db.create_unique(m2m_table_name, ['artistname_id', 'artist_id'])

        # Adding M2M table for field sounds on 'ArtistName'
        m2m_table_name = db.shorten_name('scrapers_artistname_sounds')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('artistname', models.ForeignKey(orm['scrapers.artistname'], null=False)),
            ('sound', models.ForeignKey(orm['scrapers.sound'], null=False))
        ))
        db.create_unique(m2m_table_name, ['artistname_id', 'sound_id'])

        # Adding M2M table for field albums on 'ArtistName'
        m2m_table_name = db.shorten_name('scrapers_artistname_albums')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('artistname', models.ForeignKey(orm['scrapers.artistname'], null=False)),
            ('album', models.ForeignKey(orm['scrapers.album'], null=False))
        ))
        db.create_unique(m2m_table_name, ['artistname_id', 'album_id'])

        # Adding M2M table for field users on 'ArtistName'
        m2m_table_name = db.shorten_name('scrapers_artistname_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('artistname', models.ForeignKey(orm['scrapers.artistname'], null=False)),
            ('userprofile', models.ForeignKey(orm['scrapers.userprofile'], null=False))
        ))
        db.create_unique(m2m_table_name, ['artistname_id', 'userprofile_id'])


    def backwards(self, orm):
        # Deleting model 'ArtistName'
        db.delete_table('scrapers_artistname')

        # Removing M2M table for field artists on 'ArtistName'
        db.delete_table(db.shorten_name('scrapers_artistname_artists'))

        # Removing M2M table for field sounds on 'ArtistName'
        db.delete_table(db.shorten_name('scrapers_artistname_sounds'))

        # Removing M2M table for field albums on 'ArtistName'
        db.delete_table(db.shorten_name('scrapers_artistname_albums'))

        # Removing M2M table for field users on 'ArtistName'
        db.delete_table(db.shorten_name('scrapers_artistname_users'))
    ...
    models = {
        ...
        'scrapers.artistname': {
            ...
            'albums': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'artist_names'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scrapers.Album']"}),
            'artists': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'artist_names'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scrapers.Artist']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
            'sounds': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'artist_names'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scrapers.Sound']"}),
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'artist_names'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scrapers.UserProfile']"})
        },
        'scrapers.embed': {
