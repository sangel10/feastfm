...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scrapers_userprofile_artists', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['scrapers.userprofile'], null=False)),
            ('artist', models.ForeignKey(orm['scrapers.artist'], null=False))
        ))
        db.create_unique('scrapers_userprofile_artists', ['userprofile_id', 'artist_id'])

        # Adding M2M table for field labels on 'UserProfile'
        db.create_table('scrapers_userprofile_labels', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['scrapers.userprofile'], null=False)),
            ('label', models.ForeignKey(orm['scrapers.label'], null=False))
        ))
        db.create_unique('scrapers_userprofile_labels', ['userprofile_id', 'label_id'])

        # Adding M2M table for field sources on 'UserProfile'
        db.create_table('scrapers_userprofile_sources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['scrapers.userprofile'], null=False)),
            ('source', models.ForeignKey(orm['scrapers.source'], null=False))
        ))
        db.create_unique('scrapers_userprofile_sources', ['userprofile_id', 'source_id'])

        # Adding M2M table for field mix_series on 'UserProfile'
        db.create_table('scrapers_userprofile_mix_series', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['scrapers.userprofile'], null=False)),
            ('mix_series', models.ForeignKey(orm['scrapers.mix_series'], null=False))
        ))
        db.create_unique('scrapers_userprofile_mix_series', ['userprofile_id', 'mix_series_id'])

        # Adding M2M table for field sounds on 'UserProfile'
        db.create_table('scrapers_userprofile_sounds', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['scrapers.userprofile'], null=False)),
            ('sound', models.ForeignKey(orm['scrapers.sound'], null=False))
        ))
        db.create_unique('scrapers_userprofile_sounds', ['userprofile_id', 'sound_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('scrapers_userprofile_artists')

        # Removing M2M table for field labels on 'UserProfile'
        db.delete_table('scrapers_userprofile_labels')

        # Removing M2M table for field sources on 'UserProfile'
        db.delete_table('scrapers_userprofile_sources')

        # Removing M2M table for field mix_series on 'UserProfile'
        db.delete_table('scrapers_userprofile_mix_series')

        # Removing M2M table for field sounds on 'UserProfile'
        db.delete_table('scrapers_userprofile_sounds')
