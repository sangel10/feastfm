...
#         'NAME': 'feast_virtual', #'musicbrainz',                      # Or path to database file if using sqlite3.
#         'USER': "",#'feast_virtual', #'musicbrainz',                      # Not used with sqlite3.
...
DATABASES = {'default': dj_database_url.config(default='postgres://localhost/feast_virtual')}
